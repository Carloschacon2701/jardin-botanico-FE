...
export default function HeroSection() {
  return (
    <section className="w-full px-4 pt-6 pb-8 md:px-10 lg:px-0 lg:pt-24 lg:pb-0">
      <div className="mx-auto max-w-240 grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-12 items-center">
        {/* Text content */}
        <div className="flex flex-col gap-6 md:gap-8 order-2 md:order-1 text-center md:text-left">
          {/* Mobile logo decoration */}
          <div className="flex justify-center md:hidden">
            <div className="w-21.25 h-21.25 relative">
              <Image
          ...
          <div className="flex flex-col gap-4 items-center md:items-start">
            ...
            <span className="hidden md:inline-flex self-start px-3 py-1 rounded-full bg-green-light text-xs font-bold uppercase tracking-[1.2px] text-green-primary">
              Bienvenido a nuestro espacio
            </span>

            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-black text-green-primary tracking-tight leading-tight md:leading-none">
              Descubre la magia de la naturaleza{" "}
              <span className="text-terracotta">Unetense</span>
            </h1>

            <p className="text-sm sm:text-base md:text-xl text-text-dark leading-relaxed max-w-lg">
