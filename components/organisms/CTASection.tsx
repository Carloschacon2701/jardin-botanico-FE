...
export default function CTASection() {
  return (
    <section className="w-full px-4 md:px-10 lg:px-0 py-8 md:py-12">
      <div className="mx-auto max-w-240 relative overflow-hidden rounded-xl bg-green-primary">
        {/* Background pattern */}
        ...
        <div className="relative flex flex-col items-center gap-8 px-6 py-16 md:px-24 md:py-24 text-center">
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <p className="text-base md:text-xl text-green-light opacity-90 leading-relaxed">
